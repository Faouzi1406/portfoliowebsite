<script>
    import ErvaringenAccordion from "./ErvaringenAccordion.svelte";
</script>

<div class="w-[100vw] flex items-center justify-center mt-10 flex-col">
  <h2 class="text-xl font-semibold ">Mijn ervaringen</h2>
  <div class="">

    <!-- Informatie --> 
    <div class="w-full mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
      <div class="flex flex-col gap-2">
      <p class="font-black text-[18px] text-center">Language's</p>
      <ErvaringenAccordion accordionProps={
        {
          icon:"/jsLogo.png",
          desc:"Met Javscript heb ik nogal wat applicatie's gemaakt zowel op school voor opdrachten als na school om website's te maken.",
          title:"JavaScript"
        }
      }
      />
      ...
      <div class="flex flex-col gap-2">
      <p class="font-black text-[18px] text-center">Frameworks & Library's</p>
      <ErvaringenAccordion accordionProps={
        {
          icon:"/svelteLogo.svg",
